...
mkdir /fs/project/PAS0471/osu9453/AgeCohortProject/FASTQC_PostTrim_Out
...
mkdir /fs/project/PAS0471/osu9453/AgeCohortProject/batchScripts/FASTQC_Post
cd /fs/project/PAS0471/osu9453/AgeCohortProject/batchScripts/FASTQC_Post
...
do
 ...
 echo 'cd /fs/project/PAS0471/osu9453/AgeCohortProject/FASTQC_PostTrim_Out'
 
 echo "fastqc -t 2 -o /fs/project/PAS0471/osu9453/AgeCohortProject/FASTQC_PostTrim_Out \
 $R1 $R2"
