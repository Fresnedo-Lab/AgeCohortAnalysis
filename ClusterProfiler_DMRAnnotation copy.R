...
GeneList0812 <- read.table("Heatmap/VennDiagrams/CG/Hyper/CG_0812_geneList_Hyp.txt", header = TRUE)
GeneList0817 <- read.table("Heatmap/VennDiagrams/CG/Hyper/CG_0817_geneList_Hyp.txt", header = TRUE)
GeneList1217 <- read.table("Heatmap/VennDiagrams/CG/Hyper/CG_1217_geneList_Hyp.txt", header = TRUE)
...
GeneList0812_Hypo <- read.table("Heatmap/VennDiagrams/CG/Hypo/CG_0812_geneList_Hypo.txt", header = TRUE)
GeneList0817_Hypo <- read.table("Heatmap/VennDiagrams/CG/Hypo/CG_0817_geneList_Hypo.txt", header = TRUE)
GeneList1217_Hypo <- read.table("Heatmap/VennDiagrams/CG/Hypo/CG_1217_geneList_Hypo.txt", header = TRUE)
...
df <- data.frame()
for (i in 1:nrow(Merged_GO_1217_Hypo)){
  GO <- Merged_GO_1217_Hypo$GOterm[i]
  geneID <- Merged_GO_1217_Hypo$GeneID[i]
  term <- term(go, GO)
...
CG_bioproc_0812 <- bioproc_0812[order(-bioproc_0812$count),]
write.csv(CG_bioproc_0812, "CG_BioProc_0812_hyper.csv")
molfun_0812 <- aggregate(data.frame(count = df_molfun_0812$label), list(value = df_molfun_0812$label), length)
CG_molfun_0812 <- molfun_0812[order(-molfun_0812$count),]
write.csv(CG_molfun_0812, "CG_MolFun_0812_hyper.csv")
cellcom_0812 <- aggregate(data.frame(count = df_cellcom_0812$label), list(value = df_cellcom_0812$label), length)
CG_cellcom_0812 <- cellcom_0812[order(-cellcom_0812$count),]
write.csv(CG_cellcom_0812, "CG_CellCom_0812_hyper.csv")
...
CG_bioproc_0817 <- bioproc_0817[order(-bioproc_0817$count),]
write.csv(CG_bioproc_0817, "CG_BioProc_0817_hyper.csv")
molfun_0817 <- aggregate(data.frame(count = df_molfun_0817$label), list(value = df_molfun_0817$label), length)
CG_molfun_0817 <- molfun_0817[order(-molfun_0817$count),]
write.csv(CG_molfun_0817, "CG_MolFun_0817_hyper.csv")
cellcom_0817 <- aggregate(data.frame(count = df_cellcom_0817$label), list(value = df_cellcom_0817$label), length)
CG_cellcom_0817 <- cellcom_0817[order(-cellcom_0817$count),]
write.csv(CG_cellcom_0817, "CG_CellCom_0817_hyper.csv")
...
CG_bioproc_1217 <- bioproc_1217[order(-bioproc_1217$count),]
write.csv(CG_bioproc_1217, "CG_BioProc_1217_hyper.csv")
molfun_1217 <- aggregate(data.frame(count = df_molfun_1217$label), list(value = df_molfun_1217$label), length)
CG_molfun_1217 <- molfun_1217[order(-molfun_1217$count),]
write.csv(CG_molfun_1217, "CG_MolFun_1217_hyper.csv")
cellcom_1217 <- aggregate(data.frame(count = df_cellcom_1217$label), list(value = df_cellcom_1217$label), length)
CG_cellcom_1217 <- cellcom_1217[order(-cellcom_1217$count),]
write.csv(CG_cellcom_1217, "CG_CellCom_1217_hyper.csv")
...
CG_bioproc_0812_hypo <- bioproc_0812_hypo[order(-bioproc_0812_hypo$count),]
write.csv(CG_bioproc_0812_hypo, "CG_BioProc_0812_hypo.csv")
molfun_0812_hypo <- aggregate(data.frame(count = df_molfun_0812_hypo$label), list(value = df_molfun_0812_hypo$label), length)
CG_molfun_0812_hypo <- molfun_0812_hypo[order(-molfun_0812_hypo$count),]
write.csv(CG_molfun_0812_hypo, "CG_MolFun_0812_hypo.csv")
cellcom_0812_hypo <- aggregate(data.frame(count = df_cellcom_0812_hypo$label), list(value = df_cellcom_0812_hypo$label), length)
CG_cellcom_0812_hypo <- cellcom_0812_hypo[order(-cellcom_0812_hypo$count),]
write.csv(CG_cellcom_0812_hypo, "CG_CellCom_0812_hypo.csv")
...
CG_bioproc_0817_hypo <- bioproc_0817_hypo[order(-bioproc_0817_hypo$count),]
write.csv(CG_bioproc_0817_hypo, "CG_BioProc_0817_hypo.csv")
molfun_0817_hypo <- aggregate(data.frame(count = df_molfun_0817_hypo$label), list(value = df_molfun_0817_hypo$label), length)
CG_molfun_0817_hypo <- molfun_0817_hypo[order(-molfun_0817_hypo$count),]
write.csv(CG_molfun_0817_hypo, "CG_MolFun_0817_hypo.csv")
cellcom_0817_hypo <- aggregate(data.frame(count = df_cellcom_0817_hypo$label), list(value = df_cellcom_0817_hypo$label), length)
CG_cellcom_0817_hypo <- cellcom_0817_hypo[order(-cellcom_0817_hypo$count),]
write.csv(CG_cellcom_0817_hypo, "CG_CellCom_0817_hypo.csv")
...
CG_bioproc_1217_hypo <- bioproc_1217_hypo[order(-bioproc_1217_hypo$count),]
write.csv(CG_bioproc_1217_hypo, "CG_BioProc_1217_hypo.csv")
molfun_1217_hypo <- aggregate(data.frame(count = df_molfun_1217_hypo$label), list(value = df_molfun_1217_hypo$label), length)
CG_molfun_1217_hypo <- molfun_1217_hypo[order(-molfun_1217_hypo$count),]
write.csv(CG_molfun_1217_hypo, "CG_MolFun_1217_hypo.csv")
cellcom_1217_hypo <- aggregate(data.frame(count = df_cellcom_1217_hypo$label), list(value = df_cellcom_1217_hypo$label), length)
CG_cellcom_1217_hypo <- cellcom_1217_hypo[order(-cellcom_1217_hypo$count),]
write.csv(CG_cellcom_1217_hypo, "CG_CellCom_1217_hypo.csv")
